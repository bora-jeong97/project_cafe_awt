...
public class MemberDaoImpl implements MemberDao {
	...
	public boolean getId(String id) {
		String sql = " SELECT ID " + " FROM ORDER_MEMBER " + " WHERE ID = ? ";
	...
	public boolean addMember(MemberDto dto) {
		String sql = " INSERT INTO ORDER_MEMBER(ID, PWD, NAME, EMAIL, AUTH) " + " VALUES(?, ?, ?, ?, 3) ";
	...
	public MemberDto login(String id, String pwd) {
		String sql = " SELECT ID, NAME, EMAIL, AUTH " + " FROM ORDER_MEMBER " + " WHERE ID=? AND PWD=? ";
